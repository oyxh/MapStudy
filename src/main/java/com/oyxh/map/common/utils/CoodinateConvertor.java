...
public class CoodinateConvertor {
	...
	public final static double x_pi = 3.14159265358979324 * 3000.0 / 180.0;
	     ...
	     * 
	     * @Title: wgs2bd 
	     * @Description: 84to火星坐标系(GCJ-02)World Geodetic System==>Mars Geodetic System   
	     ...
	     * 
	     * @Title: gcj2bd 
	     * @Description:火星坐标系(GCJ-02)与百度坐标系(BD-09)的转换算法，将GCJ-02坐标转换成BD-09坐标  
	     * @param lat
	     * @param lon
	     * @return
	     */
	     ...
	     * 
	     * @Title: gcj2bd 
	     * @Description: 百度坐标系(BD-09)与火星坐标系(GCJ-02)的转换算法，将BD-09坐标转换成GCJ-02坐标  
	     * @param lat
	     * @param lon
	     * @return
	     */
